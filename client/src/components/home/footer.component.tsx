			...
			<div className='container grid grid-cols-3'>
				<div className='col-span-1 space-y-8'>
					...
					<div className='flex space-x-6'>
						<a href='src/components#' className='text-gray-400 hover:text-gray-500'>
							<i
								className='fa-brands fa-facebook-square'></i>
						</a>
						<a href='src/components#' className='text-gray-400 hover:text-gray-500'>
							<i
								className='fa-brands fa-instagram-square'></i>
						</a>
						<a href='src/components#' className='text-gray-400 hover:text-gray-500'>
							<i
								className='fa-brands fa-twitter-square'></i>
						</a>
						<a href='src/components#' className='text-gray-400 hover:text-gray-500'>
					...
					<div className='grid grid-cols-2 gap-8'>
						<div>
							...
							<div className='mt-4 space-y-4'>
								<a href='src/components#' className='text-base text-gray-500 hover:text-gray-900 block'>Marketing</a>
								<a href='src/components#' className='text-base text-gray-500 hover:text-gray-900 block'>Analitycs</a>
								<a href='src/components#' className='text-base text-gray-500 hover:text-gray-900 block'>Commerce</a>
								<a href='src/components#' className='text-base text-gray-500 hover:text-gray-900 block'>Insights</a>
							</div>
						</div>
